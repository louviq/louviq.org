...
- [[#package-configuration][Package Configuration]]
  ...
  - [[#org][Org]]
    ...
    - [[#another-image-insertion-scheme][Another image insertion scheme]]
...
#+begin_src emacs-lisp
(setq
 doom-font (font-spec :family "Iosevka" :size 34)
...
*** Another image insertion scheme
...
**** Teleport with Tramp
:PROPERTIES:
:ID:       cd0e64f7-a8fe-494b-b2f1-498e0c973359
:END:
