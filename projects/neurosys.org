...
#+begin_src haskell
  ...
  , ((m .|. shiftMask .|. mod1Mask, xK_s), spawn "/home/dan/.screenlayout/bsecondary.sh && feh --bg-fill --no-xinerama --randomize ~/Media/images/wallpaper/*" )
#+end_src
...
#_sudo timedatectl set-timezone America/Los_Angeles
